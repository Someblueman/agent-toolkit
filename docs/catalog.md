...
| [fanout](../skills/fanout/) | Model-agnostic review, critique, bug-hunt, and implementation workflows; plain one-shot workers. | stable |
...
| Name | Description | Status |
|------|-------------|--------|
| [fanout](../tools/fanout/) | Run bounded one-shot local workers (Agy / OpenCode / Muse / Pi / Claude Code) and collect structured results. | stable |
